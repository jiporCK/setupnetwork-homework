...
function init(){
    ...
    export PATH=$PATH:/home/jipor/blockchain/setup-network-demo/simple-blockchain-demo/personal-network/bin
    # we should use this 
    # export .. $(pwd)/config 
    export FABRIC_CFG_PATH=/home/jipor/blockchain/setup-network-demo/simple-blockchain-demo/personal-network/config
}
